  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51POZWiHuvfcKsLKCPEQeKq2d3CnCrqQgfZvPKK7VDUozpqyQZ4K8xX1I6D0a9cYwGdCKLcVqrIZnhRgvegDrzAYs00qcL3rNYN'); // 1) Get checkout session from API
          _context.next = 4;
